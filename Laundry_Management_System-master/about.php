...
<section class="header">
   ...
   <a href="home.php" class="logo">WAAR Cleaners</a>
...
<section class="about">
   ...
   <div class="content">
      <h3>Why Choose Us?</h3>
       ...
       <p>Our core value differentiator is the most trusted user experience. Through Blitzers, our customers enjoy standardised Cleaning experience at certified Blitz Outlets.</p>
      <p>With industry first virtual Laundry booking currency Blitzcash and laundry social network, Blitz+ Rewards - Blitz Cleaners is the number one choice for new India on the move.</p>
...
<section class="footer">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <a> <i class="fas fa-envelope"></i> waarcleaners@gmail.com </a>
